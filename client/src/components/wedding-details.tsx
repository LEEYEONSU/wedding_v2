        ...
        >
          ...
          <motion.div variants={itemVariants} className="bg-white rounded-lg p-6 shadow-sm">
            <div className="text-warm-brown mb-4">
              ...
              <h3 className="font-medium text-lg">Invitation</h3>
            </div>
            <div className="space-y-2 text-charcoal">
              <p className="text-base">
                <span className="font-bold">이용준</span> · <span className="font-bold">김희아(은아)</span>의 딸 <span className="font-bold">이연수</span>
              </p>
              <p className="text-base">
